...
- 🤖 [AI-EDA Agent – Autonomous Data Analysis](https://github.com/SamLB9/ai-eda-agent): An intelligent agent that performs complete Exploratory Data Analysis automatically in ~2 minutes. Powered by OpenAI's GPT-5, it generates insights, visualizations, and statistical analysis with zero manual intervention. Features include pre-loaded demo datasets (Spotify, Titanic, Video Game Sales), smart visualizations with descriptive titles, comprehensive statistical insights, and sandboxed code execution for safety. The system uses LLM-generated Python code executed in a controlled environment, making advanced data analysis accessible to users of all skill levels.
