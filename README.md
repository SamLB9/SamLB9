...
- 🎓 [Edvance Study Coach](https://github.com/SamLB9/Edvance) ([Live Demo](https://edvance-production.up.railway.app/)): A production-ready, multi-user AI-powered RAG platform deployed on Railway that ingests course materials (PDF/TXT/MD), builds semantic vector stores with ChromaDB, and generates adaptive quizzes with intelligent difficulty adjustment based on historical performance. Features include LLM-powered question generation (MCQ, True/False, Short Answer, Matching), personalized feedback, progress analytics, professional LaTeX-based PDF summarization with file-specific context filtering, flashcard generation, and secure multi-tenant architecture. Built with LangChain, OpenAI embeddings, and Streamlit.
- 🎓 [MSc Dissertation – Comparative Analysis of GAN- and Diffusion-Generated Images for Generalizable Deepfake Detection](https://github.com/SamLB9/GAN-vs.-Diffusion-Images) (Grade: 79%) — University of Edinburgh (2024–2025). I explored shared and distinct visual patterns (color, noise, frequency, texture) of GAN- and diffusion-generated images to address these limitations and inform the design of more generalizable detectors. Results show that diffusion-based training and frequency-domain features improve cross-architecture generalization, paving the way for more robust, lightweight deepfake detection methods.
