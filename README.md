...
- 🎓 [Edvance Study Coach](https://github.com/SamLB9/Edvance): A production-ready, multi-user AI-powered RAG platform deployed on Railway that ingests course materials (PDF/TXT/MD), builds semantic vector stores with ChromaDB, and generates adaptive quizzes with intelligent difficulty adjustment based on historical performance. Features include LLM-powered question generation (MCQ, True/False, Short Answer, Matching), personalized feedback, progress analytics, professional LaTeX-based PDF summarization with file-specific context filtering, flashcard generation, and secure multi-tenant architecture. Built with LangChain, OpenAI embeddings, and Streamlit. [Live Demo](https://edvance-production.up.railway.app/)
